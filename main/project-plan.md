...
2026-08-03 - Resend live: API key stored as Pages secret, recipient set to haikaitechsolutions@gmail.com (admin@haikaitech.my permanently bounces — Email Routing has no forwarding rule), deployed, E2E verified (POST /api/leads 201 -> D1 row -> email delivered). Test data cleaned (0 leads). Remaining: click Verify in Resend to complete DKIM (domain partially_verified).
